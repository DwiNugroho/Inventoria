            ...
            <div class="card-header form-inline d-flex justify-content-between">
                ...
                <span class="form-group ml-2">
                    <?php if ($this->session->userdata('level') > 2) : ?>
                        ...
                        <a class="btn btn-primary btn-sm" href="<?= base_url(); ?>Kategori/tambah"><i class="fa fa-plus"></i> Tambah data</a>
                    <?php endif ?>
                </span>
            </div>
            <div class="card-body">
                            ...
                            foreach ($kategori as $k) : ?>
                                <?php if ($k['id_kategori'] != '1') : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($this->session->userdata('level') > 2) : ?>
                                                <a class="btn btn-info btn-sm" href="<?= base_url(); ?>Kategori/ubah/<?= $k['id_kategori'] ?>"><i class="fa fa-pen"></i> Ubah</a>
                                            <?php endif ?>
                                        </td>
