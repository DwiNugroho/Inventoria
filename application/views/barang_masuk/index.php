        ...
        <div class="card">
            <div class="card-header form-inline d-flex justify-content-between">
                ...
                <span class="form-group ml-2">
                    <a class="btn btn-yellow btn-sm mr-2" href="<?= base_url(); ?>Barang_masuk/cetak" target="_blank"><i class="far fa-file-pdf"></i> Cetak PDF</a>
                    <a class="btn btn-primary btn-sm" href="<?= base_url(); ?>Barang_masuk/tambah"><i class="fa fa-plus"></i> Tambah data</a>
                </span>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($barang_masuk as $x) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>Barang_masuk/detail/<?= $x['id_masuk'] ?>" class="btn btn-info btn-sm">Detail</a>
                                    </td>
